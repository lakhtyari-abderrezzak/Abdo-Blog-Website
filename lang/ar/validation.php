...
return [
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على أحرف ورموز من بايت واحد فقط.',
    ...
    'date_format' => 'يجب أن يتطابق حقل :attribute مع تنسيق :format.',
    ...
    'digits' => 'يجب أن يحتوي حقل :attribute على :digits أرقامًا.',
    ...
    'exists' => 'العنصر المحدد في حقل :attribute غير صالح.',
    ...
    'hex_color' => 'يجب أن يحتوي حقل :attribute على لون هكسadecimally صالح.',
    ...
    'max' => [
        'array' => 'يجب أن يحتوي حقل :attribute على أقل من أو يساوي :max عنصرًا.',
        'file' => 'يجب أن يكون حجم حقل :attribute أقل من أو يساوي :max كيلوبايت.',
        'numeric' => 'يجب أن يكون حقل :attribute أقل من أو يساوي :max.',
        'string' => 'يجب أن يحتوي حقل :attribute على أقل من أو يساوي :max حرفًا.',
    ],
    ...
    'min_digits' => 'يجب أن يحتوي حقل :attribute على :min أرقامًا على الأقل.',
    ...
    'password' => [
        ...
        'uncompromised' => 'حقل :attribute يحتوي على تسربات في البيانات. يرجى اختيار كلمة مرور مختلفة.',
    ],
    ...
    'uploaded' => 'لم يتم تحميل حقل :attribute.',
